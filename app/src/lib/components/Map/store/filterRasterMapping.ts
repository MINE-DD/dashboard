...
export const filterToRasterMappings: FilterToRasterMapping[] = [
  ...
  { pathogen: 'Shigella spp.', ageGroup: '0-11 months', syndrome: 'Asymptomatic', layerId: `cog-${baseR2url}01_Pathogens-SHIG-SHIG_0011_Asym_Pr-tif`.replace(/[\/\.]/g, '-') },
  { pathogen: 'Shigella spp.', ageGroup: '0-11 months', syndrome: 'Community', layerId: `cog-${baseR2url}01_Pathogens-SHIG-SHIG_0011_Comm_Pr-tif`.replace(/[\/\.]/g, '-') },
  { pathogen: 'Shigella spp.', ageGroup: '0-11 months', syndrome: 'Medical', layerId: `cog-${baseR2url}01_Pathogens-SHIG-SHIG_0011_Medi_Pr-tif`.replace(/[\/\.]/g, '-') },

  // Age group 12-23 months
  { pathogen: 'Shigella spp.', ageGroup: '12-23 months', syndrome: 'Asymptomatic', layerId: `cog-${baseR2url}01_Pathogens-SHIG-SHIG_1223_Asym_Pr-tif`.replace(/[\/\.]/g, '-') },
  { pathogen: 'Shigella spp.', ageGroup: '12-23 months', syndrome: 'Community', layerId: `cog-${baseR2url}01_Pathogens-SHIG-SHIG_1223_Comm_Pr-tif`.replace(/[\/\.]/g, '-') },
  { pathogen: 'Shigella spp.', ageGroup: '12-23 months', syndrome: 'Medical', layerId: `cog-${baseR2url}01_Pathogens-SHIG-SHIG_1223_Medi_Pr-tif`.replace(/[\/\.]/g, '-') },

  // Age group 24-59 months
  { pathogen: 'Shigella spp.', ageGroup: '24-59 months', syndrome: 'Asymptomatic', layerId: `cog-${baseR2url}01_Pathogens-SHIG-SHIG_2459_Asym_Pr-tif`.replace(/[\/\.]/g, '-') },
  { pathogen: 'Shigella spp.', ageGroup: '24-59 months', syndrome: 'Community', layerId: `cog-${baseR2url}01_Pathogens-SHIG-SHIG_2459_Comm_Pr-tif`.replace(/[\/\.]/g, '-') },
  { pathogen: 'Shigella spp.', ageGroup: '24-59 months', syndrome: 'Medical', layerId: `cog-${baseR2url}01_Pathogens-SHIG-SHIG_2459_Medi_Pr-tif`.replace(/[\/\.]/g, '-') },
];
